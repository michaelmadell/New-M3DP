  ...
  return (
    <div suppressHydrationWarning className="overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center tech-grid">
        ...
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-[var(--color-bg)]/20 to-[var(--color-bg)]/70" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 opacity-0 animate-fade-in">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Button asChild variant="digital" size="lg">
                  <Link href="/quote">Get Custom Quote</Link>
                </Button>
                <Button asChild variant="analog" size="lg">
              ...
              <div className="grid grid-cols-3 gap-8 pt-8 border-t border-[#2D3142]">
                <div>
                  <div className="text-3xl font-bold text-[var(--digital-cyan)]">
                    50+
                  </div>
                ...
                <div>
                  <div className="text-3xl font-bold text-[var(--analog-amber)]">
                    12/7
                  </div>
                  <div className="text-sm text-[var(--color-muted)] mt-1">
                    Quote Response
            ...
            <div className="relative lg:h-[600px] opacity-0 animate-fade-in anim-delay-200">
              {/* Ambient glow behind the panel */}
              <div className="absolute inset-0 bg-gradient-to-tr from-[var(--color-primary)]/25 to-[var(--color-secondary)]/15 blur-2xl" />

              <div className="relative h-full flex items-center justify-center">
                <div className="maker-panel w-full h-full flex items-center justify-center">
                  <div className="maker-panel-shine" />

                  <div className="maker-panel-content text-center space-y-4 p-10">
                    <div className="text-8xl drop-shadow-[0_10px_35px_rgba(0,0,0,0.35)]">
                      🔧
                    </div>

                    <div className="text-2xl font-bold text-[var(--color-primary)] tracking-widest">
                      [ MAKER SPACE ]
                    </div>

                    <div className="text-sm text-[var(--color-fg)]/80 tracking-wide">
                      Digital → Physical
                    </div>

                    {/* Optional: tiny “status line” for the CRT vibe */}
                    <div className="pt-3 text-xs text-[var(--color-fg)]/60">
                      SIGNAL: OK • GRID: ACTIVE • MODE: {`{`}FAB{`}`}
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="relative py-24 bg-[var(--color-surface)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-0">
            {/* 3D Printing - Digital */}
            <div className="card border-r-0 lg:border-r bg-[var(--color-surface-2)] border-[var(--color-border)] group opacity-0 animate-fade-in anim-delay-100">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <div className="text-s text-[var(--color-secondary)] font-bold tracking-widest mb-1">
                    DIGITAL
                  </div>
              ...
              <div className="space-y-4 text-[var(--color-fg)]/60  mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    From CAD models to physical reality
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-[var(--color-primary)] mt-1">▸</span>
                  <div>
                    ...
                    PLA, ABS, PETG for different applications
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-[var(--color-primary)] mt-1">▸</span>
                  <div>
                    ...
                    STL, OBJ, 3MF, STEP, engineering drawings
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-[var(--color-primary)] mt-1">▸</span>
                  <div>
                    ...
                    Recreate broken or missing components
                  </div>
                </div>
              </div>
            ...
            <div className="card group bg-[var(--color-surface-2)] border-[var(--color-border)] opacity-0 animate-fade-in anim-delay-200">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <div className="text-s text-[var(--analog-amber)] font-bold tracking-widest mb-1">
                    ANALOG
                  </div>
              ...
              <div className="space-y-4 text-[var(--color-fg)]/60 mb-8">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    Careful recovery of vintage images
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-[var(--analog-amber)] mt-1">▸</span>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    Preserve your memories professionally
                  </div>
                </div>
              </div>
              ...
              <Link
                href="/contact"
                className="btn btn-analog bg-[var(--analog-amber)]/40 text-[var(--color-secondary-foreground)] hover:bg-[var(--analog-amber)] hover:shadow-lg transition-all shadow-[0_4px_6px_-1px_rgba(var(--analog-amber),0.1),0_2px_4px_-1px_rgba(var(--analog-amber),0.06)]"
              >
                Learn More
              </Link>
            </div>
      ...
      <section className="py-24 tech-grid relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            ...
            <Link
              href="/gallery"
              className="text-[var(--digital-cyan)] hover:text-[var(--analog-amber)] transition-colors font-bold tracking-wider border-[var(--digital-cyan)] border-2 p-2 bg-[var(--digital-cyan)]/10 rounded-lg hover:bg-[var(--analog-amber)]/20 hover:border-[var(--analog-amber)]"
            >
              VIEW ALL →
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
              <div
                ...
                } ${i % 2 === 0 ? "opacity-0 animate-fade-in anim-delay-100" : "opacity-0 animate-fade-in anim-delay-200"}`}
      ...
      <section id="grad" className="relative py-32 bg-[var(--light-dark-grad)] text-[var(--color-fg)] text-center overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-5xl lg:text-6xl font-bold mb-6 opacity-0 animate-fade-in">
            Ready to{" "}
            <span className="bg-[var(--analog-amber)] bg-clip-text text-transparent ">
              Create
            </span>
            ?
          </h2>
          <p className="text-2xl mb-8 opacity-0 animate-fade-in anim-delay-100">
            Upload your 3D model for an instant quote, or get in touch to
            discuss your film processing needs.
          </p>
          <div className="flex flex-wrap justify-center gap-6 opacity-0 animate-fade-in anim-delay-200">
            <Button asChild variant="digital" size="lg">
              <Link href="/quote">Get 3D Print Quote</Link>
            </Button>
